...
if(message.author.bot || message.channel.type === "dm") return;
  if (!message.guild) {
    ...
    if (!emojis || emojis === []) return message.reply("<a:uyar:1114935085406367794> Sunucuya hiç emoji eklenmemiş!");
  if (emojis.length < 1) return message.reply("<a:uyar:1114935085406367794> Sunucuya hiç emoji eklenmemiş!");
    if (emojis.length > 1) {
        var page = 1;
